				...
				<div class="bg-white shadow overflow-hidden sm:rounded-lg">
					<div class="px-4 py-5 border-b border-gray-200 sm:px-6">
						<h3 class="text-lg leading-6 font-medium text-gray-900">Post
							#{{$post->id}} Informació</h3>
						<p class="mt-1 max-w-2xl text-sm leading-5 text-gray-500">Informació personal.</p>
					...
					<div>
						<dl>
							<div
								...
								<dt class="text-sm leading-5 font-medium text-gray-500">Titol</dt>
								<dd
									class="mt-1 text-sm leading-5 text-gray-900 sm:mt-0 sm:col-span-2">
									<input
										class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
										id="grid-title" type="text" name="title"
										value="{{$post->title}}">
								</dd>
							</div>
							<div
